#!/usr/bin/env python3
"""sen0414_build_slides_lineage v1_0_0 - the SEN0414 slide-renewal lineage, one stage per commit.
...
from slides_lineage_mission_v1_0_0 import mission_block  # noqa: E402
import sen0414_slides_stages_v1_0_0 as st  # noqa: E402

REPO = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
NS = "http://example.org/sen0414-slides-lineage#"
...
<http://example.org/sen0414-slides-lineage> a owl:Ontology ;
    rdfs:label "Delivery lineage for renewing the SEN0414 lecture decks"@en ;
    owl:versionInfo "%s" ; dcterms:identifier "sen0414_slides_lineage" .

ex:Lineage a backlog:Lineage ;
    rdfs:label "First lineage run for the SEN0414 decks"@en ;
...
def main():
    ...
    if STAGES >= 5 or STAGES == 6:
        import sen0414_slides_backlog_v1_1_0 as bk
        t += bk.backlog_block()
