#!/usr/bin/env python3
"""Browser tests for version 3 of a SEN0414 page - the owner's rules of 2026-09-25 made checkable:
...
page_path = os.environ.get("PAGE", os.path.join(REPO, "03-materials", N, "page", "sen0414_%s_page_v%s.html" % (N, os.environ.get("PAGE_VER", "3_0_0"))))
