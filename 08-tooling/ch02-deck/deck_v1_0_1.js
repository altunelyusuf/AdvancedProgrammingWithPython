...
const EX = JSON.parse(fs.readFileSync('examples_out_v1_0_1.json')); const py = EX._python; const PR = EX._programs;
...
prog(s,'branching_v1_0_1.py',0.5,1.45,4.6,2.4); runs(s,'branching_v1_0_1.py',5.4,1.45,4.1,2.4);
...
prog(s,'matching_v1_0_1.py',0.5,1.45,4.9,2.6); runs(s,'matching_v1_0_1.py',5.7,1.45,3.8,2.6);
