#!/usr/bin/env python3
"""Version 2 of a SEN0414 chapter page: the template filled with the chapter's page data.
...
live in the template; this script only injects data. Usage: sen0414_page_build_v2_0_0.py <NN>"""
import json, os, sys
N = sys.argv[1]; REPO = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
T = open(os.path.join(REPO, "08-tooling", "sen0414_page_template_v2_0_0.html")).read()
...
out = os.path.join(REPO, "03-materials", "ch%s" % N, "page", "sen0414_ch%s_page_v2_0_0.html" % N)
