...
Usage: sen0414_page_data_v2_0_0.py <NN> <python>  ->  08-tooling/chNN-page/page_data_v2.json"""
...
data = {"course": COURSE, "discussion": json.load(open(DISC)) if os.path.exists(DISC) else [], "findings": findings, "unit": None,
